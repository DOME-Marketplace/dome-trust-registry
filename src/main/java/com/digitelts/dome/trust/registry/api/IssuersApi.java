...
public interface IssuersApi {
    ...
    default ResponseEntity<ListIssuers200Response> listIssuers(
        ...
        links.setFirst("http://localhost:8080/v4/issuers?pageAfter=0&pageSize=" + pageSize);
        ...
        links.setLast("http://localhost:8080/v4/issuers?pageAfter=" + (totalPages - 1) + "&pageSize=" + pageSize);
