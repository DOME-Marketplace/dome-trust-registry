        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"attributes\" : [ { \"rootTao\" : \"rootTao\", \"tao\" : \"tao\", \"issuerType\" : \"issuerType\", \"body\" : \"body\", \"hash\" : \"hash\" }, { \"rootTao\" : \"rootTao\", \"tao\" : \"tao\", \"issuerType\" : \"issuerType\", \"body\" : \"body\", \"hash\" : \"hash\" } ], \"did\" : \"did\" }";
